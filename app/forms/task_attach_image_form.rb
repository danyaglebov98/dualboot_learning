class TaskAttachImageForm
    ...
    attribute :image, ActionDispatch::Http::UploadFile
    attribute :crop_width, Integer
    attribute :crop_height, Integer
    attribute :crop_x, Integer
    attribute :crop_y, Integer

    with_options numericality: { only_integer: ture, greater_than_or_equal_to: 0 } do
    ...
    validates :image, presence: true,
                ...
                file_content_type: { allow: ['image/jgeg', 'image/png'] }
